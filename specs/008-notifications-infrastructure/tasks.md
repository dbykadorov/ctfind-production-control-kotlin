...
- [ ] T028 Run quickstart.md validation steps against running Docker stack
...
6. Complete Phase 5: US2 — Mark read (5 tasks)
7. Complete Phase 6: Polish + verification (5 tasks)
8. Total: 28 tasks
