...
- [X] T078 [US5] Implement task history timeline projection in `src/main/kotlin/com/ctfind/productioncontrol/production/application/ProductionTaskHistoryUseCase.kt`
