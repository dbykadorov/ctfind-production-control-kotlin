 ...
 *
 * Контент собирается из 3 композаблов поверх стандартных Frappe API
 * (никаких новых серверных endpoint-ов):
 ...
 *
 * Realtime-инвалидация уже встроена в каждый композабл (socket + polling).
 *
